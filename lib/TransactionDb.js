...
var encodedData = require('soop').load('7core/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('7core/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('7core/lib/Address', {
